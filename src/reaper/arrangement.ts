import type { Region, SongId, TimeSignature } from "../domain/song.js";
...
export interface ArrangementCue { readonly phrase:string;readonly atSeconds:number;readonly targetRegionId:string; }
...
export interface ProPresenterMidiEvent { readonly atSeconds:number;readonly status:number;readonly channel:number;readonly data1:number;readonly data2:number;readonly kind:"note-on"|"note-off"|"control-change"|"other"; }
