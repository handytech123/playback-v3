...
declare global {
  interface Window {
    playback: {
      ...
      performance: { get(): Promise<any>; command(value: any): Promise<any>; saveMix():Promise<any>; onState(listener: (state: any) => void): void; onMeters(listener: (meters: { master: number; channels: readonly number[] }) => void): void };
