...
declare global {
  interface Window {
    playback: {
      ...
      audio: { setDevice(device: { type: string; name: string } | null): Promise<any>; setRouting(routing: any): Promise<any>; setGlobalBusRouting(routing: any): Promise<any>; refresh(): Promise<any>; onHealth(listener:(health:any)=>void):void };
