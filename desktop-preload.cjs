...
contextBridge.exposeInMainWorld("playback", {
  gldBus: {
    ...
    disarm:()=>ipcRenderer.invoke("gld-bus:disarm"), preview:()=>ipcRenderer.invoke("gld-bus:preview"),save:()=>ipcRenderer.invoke("gld-bus:save"),saveAll:()=>ipcRenderer.invoke("gld-bus:save-all"),
